  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-[1] w-20 h-20 bg-green-900/40 border-2 border-green-700/50 rounded-full flex items-center justify-center mx-auto"
      >
      ...
      <motion.div
        ...
        className="relative z-[1] bg-white/[0.03] rounded-lg p-4 text-left border border-white/10"
      >
      ...
      >
        <Link href="/status" className="btn-secondary block text-center">
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 bg-green-700 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-lg
        ...
        >
          ...
          Follow us @thefirstruleclub for event updates
        </a>

        <Link href="/register" className="text-gray-600 hover:text-gray-400 text-sm transition-colors text-center">
