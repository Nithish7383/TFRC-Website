    ...
    <main className="min-h-screen bg-black">
      ...
      <div className="max-w-md w-full text-center">
        <div className="card space-y-5">
          {/* Success icon */}
          <div className="w-20 h-20 bg-green-900/40 border-2 border-green-700/50 rounded-full flex items-center justify-center mx-auto">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 bg-green-700 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-lg transition-colors"
            >
            ...
            <Link href="/register" className="text-gray-600 hover:text-gray-400 text-sm transition-colors">
